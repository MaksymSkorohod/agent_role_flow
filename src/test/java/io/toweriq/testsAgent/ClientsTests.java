...
public class ClientsTests extends TestBase {
    ...
    @Test(description = "Creating the schedule from the company landing page")
    public void createScheduleFromCompanyLandingPage(){
        fillCompanyPage();
        companiesPage
                .getAllCompaniesPageHeader().isExists();
        companiesPage
                ...
                .getClientsLandingPageHeader().isExists(2);
        companiesPage
                .clickClientInformationTab()
                .clickScheduleSubTab()
                .clickScheduleOption()
                .clickOnActionsButton()
                .clickAddSchedulesOption()
                .getCreateScheduleModal().isExists();
        companiesPage
