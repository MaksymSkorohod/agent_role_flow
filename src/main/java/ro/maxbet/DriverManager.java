...
public class DriverManager {
    ...
    public static void clickOnElement(String xPath){
        try {
            ...
            executor.executeScript("arguments[0].click()", getDriver().findElement(By.xpath(xPath)));
        }
    }
    ...
    public static void hoverToElement(By elementLocator) {
        WebElement elementToHover = DriverManager.getDriver().findElement(elementLocator);
        ((JavascriptExecutor) getDriver()).executeScript("arguments[0].scrollIntoView(true);", elementToHover);
    }
